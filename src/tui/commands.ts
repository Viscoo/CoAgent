...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: "/msg", description: "Send a message to a peer agent", requiresArg: true, handler: async () => {} },
  { name: "/broadcast", description: "Broadcast a message to all peers", requiresArg: true, handler: async () => {} },
